...
icon011.onclick = function () {
	page1.style.display="none";
	page2.style.display="block";
}
icon021.onclick = function () {
	page2.style.display="none";
	page4.style.display="block";
}
icon022.onclick = function () {
	page2.style.display="none";
	page3.style.display="block";
}
icon023.onclick = function () {
	page2.style.display="none";
	page6.style.display="block";
}
icon024.onclick = function () {
	page2.style.display="none";
	page5.style.display="block";
}
icon025.onclick = function () {
	page2.style.display="none";
...
icon042.onclick = function () {
	page4.style.display="none";
	page2.style.display="block";
}
icon043.onclick = function () {
	page4.style.display="none";
	page2.style.display="block";
}
icon052.onclick = function () {
	page5.style.display="none";
	page2.style.display="block";
}
icon053.onclick = function () {
	page5.style.display="none";
	page2.style.display="block";
}
icon062.onclick = function () {
...
icon072.onclick = function () {
	page7.style.display="none";
	page2.style.display="block";
}
icon073.onclick = function () {
	page7.style.display="none";
	page2.style.display="block";
}
icon081.onclick = function () {
...
text173.onclick = function () {
	page17.style.display="none";
	page19.style.display="block";
}
icon182.onclick = function () {
	page18.style.display="none";
	cover.style.display="block";
}
text181.onclick = function () {
	page18.style.display="none";
	cover.style.display="block";
}
